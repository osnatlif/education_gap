...
beta24_w = -0.0001	  # exp^2 CG
beta25_w = -0.0001	  # exp^2 PC
beta31_w = 9.657	    # HSD
beta32_w = 9.783	    # HSG
beta33_w = 9.974	    # SC
beta34_w = 10.294	    # CG
...
beta23_h = -0.0001	 # exp^2 SC
beta24_h = -0.0001	 # exp^2 CG
beta25_h = -0.0001	 # exp^2 PC
beta31_h = 9.877	   # hsd
beta32_h = 9.939     # hsg
beta33_h = 10.180	   # sc
beta34_h = 10.464	   # cg
...
lambda0_w_ft = 0.37	  # job offer parameters - wife - full time	constant
lambda1_w_ft = 0.06	  # job offer parameters - wife	experience
lambda2_w_ft = 0.1191	  # job offer parameters - wife	education
lambda0_h_ft = 1.82 	  # job offer parameters - husband - full Time	constant
lambda1_h_ft = 0.10	      # job offer parameters - husband	experience
lambda2_h_ft = 0.16	  # job offer parameters - husband	education
# job offer parameters - part-time
lambda0_w_pt = -1.92	  # job offer parameters - wife - part-time	constant
lambda1_w_pt = 0.01	  # job offer parameters - wife	experience
lambda2_w_pt = 0.06	  # job offer parameters - wife	education
...
lambda2_h_pt = 0.00	  # job offer parameters - husband	education
# get fired
lambda0_w_f = 1.89	    # job offer parameters - wife - not fired  ( PT FT)	constant
lambda1_w_f = 0.19	    # job offer parameters - wife	experience
lambda2_w_f = 0.11	  # job offer parameters - wife	education
lambda0_h_f = 1.91	    # job offer parameters - husband - not fired (PT FT)	constant
lambda1_h_f = 0.27	    # job offer parameters - husband	experience
lambda2_h_f = 0.09	  # job offer parameters - husband	education
##############################################################################
# fixed parameters
##############################################################################
...
taste_c = 40.485	         # taste for marriage	constant
taste_w_up = -15.894  	 # taste for marriage	schooling gap - men more educated
taste_w_down = -20.227	 # taste for marriage	schooling gap - women more educated
taste_health = 0         # taste for marriage	health gap
preg_health = 0.0002     # utility from pregnancy - health
preg_unmarried = -49.429	   # utility from pregnancy -	married
preg_t_minus1 = -30.227   # utility from pregnancy - pregnancy in t-1
preg_kids = -23.98       # utility from pregnancy - number of kide
...
# welfare parameters
stigma = -24.742	      # disutility from welfare
...
alpha3_w_m = 0.78722	   # utility parameters - wife	utility from kids when married
...
mc = -10.946	             # fixed cost of getting married
mc_by_parents = -412.691	 # cost of marriage by parents marital status
dc_w = -500.579	           # fixed cost of divorce wife	alpha4
dc_h = -500.691	           # fixed cost of divorce husband	alpha4
...
sigma_ability_w = np.exp(-2.549)	 # random shock variance matrix	variance wife ability
sigma_ability_h = np.exp(-2.592)	 # random shock variance matrix	variance husband ability
...
sigma_w_wage = np.exp(-2.620) 	   # random shock variance matrix	wife's wage error variance
sigma_h_wage = np.exp(-2.624) 	   # random shock variance matrix	husband's wage error variance
sigma_q = np.exp(-1.822)	         # random shock variance matrix	match quality variance
sigma_p = np.exp(-1.225)	         # random shock variance matrix	pregnancy
# utility from schooling parameters
s1_w = 0.432	   # utility from schooling - wife	s1_w constant
s2_w = 592.469	   # utility from schooling - wife	s2_w mother is CG
s3_w = 630.674	   # utility from schooling - wife	s3_w return for ability
s4_w = -430.429	 # utility from schooling - wife+husband	s4_w post high school tuition
s1_h = 0.375	   # utility from schooling - husband	s1_h constant
s2_h = 526.582	   # utility from schooling - husband	s2_h mother is  CG
s3_h = 622.719	   # utility from schooling - husband	s3_h return for ability
# terminal value parameters
t1_w = 10.918	 # terminal value - wife:	wife Education - HSG
t2_w = 20.462	 # terminal value - wife:	wife Education - SC
t3_w = 30.885	 # terminal value - wife:	wife Education - CG
t4_w = 40.247	 # terminal value - wife:	wife Education - PC
t5_w = 21.278	 # terminal value - wife:	wife experience
t6_w = 8.210 	 # terminal value - wife: husband education - HSG
t7_w = 19.216	 # terminal value - wife:	husband education - SC
t8_w = 23.130	 # terminal value - wife:	husband education - CG
t9_w = 41.873	 # terminal value - wife:	husband education - PC
t10_w = 16.833	 # terminal value - wife:	husband experience
t11_w = 112.743	 # terminal value - wife:	marriage utility
t1_h = 10.942	 # terminal value - husband: wife Education - HSG
t2_h = 20.655	 # terminal value - husband: wife Education - SC
t3_h = 30.843	 # terminal value - husband: wife Education - CG
t4_h = 40.215	 # terminal value - husband: wife Education - PC
t5_h = 5.222	   # terminal value - husband: wife	experience
t6_h = 7.880	 # terminal value - husband: husband education - HSG
t7_h = 19.516	 # terminal value - husband: husband education - SC
t8_h = 33.348	 # terminal value - husband: husband education - CG
t9_h = 41.876	 # terminal value - husband: husband education - PC
