...
cdef double s1_w = 55.432	   # utility from schooling - wife	s1_w constant
cdef double s2_w = 32.469	   # utility from schooling - wife	s2_w mother is CG
cdef double s3_w = 16.674	   # utility from schooling - wife	s3_w return for ability
cdef double s4_w = -2.429	 # utility from schooling - wife+husband	s4_w post high school tuition
cdef double s1_h = 35.375	   # utility from schooling - husband	s1_h constant
cdef double s2_h = 12.582	   # utility from schooling - husband	s2_h mother is  CG
cdef double s3_h = 6.719	   # utility from schooling - husband	s3_h return for ability
