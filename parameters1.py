...
beta21_w	=	-0.001	#	exp^2 HSD
beta22_w	=	-0.001	#	exp^2 HSG
beta23_w	=	-0.001	#	exp^2 SC
beta24_w	=	-0.002	#	exp^2 CG
beta25_w	=	-0.002	#	exp^2 PC
beta31_w	=	9.657	#	HSD
beta32_w	=	9.783	#	HSG
beta33_w	=	9.974	#	SC
beta34_w	=	10.294	#	CG
...
beta21_h	=	-0.001	#	exp^2 HSD
beta22_h	=	-0.001	#	exp^2 HSG
beta23_h	=	-0.002	#	exp^2 SC
beta24_h	=	-0.002	#	exp^2 CG
beta25_h	=	-0.002	#	exp^2 PC
beta31_h	=	9.877	#	HSD
beta32_h	=	9.939	#	HSG
beta33_h	=	10.180	#	SC
beta34_h	=	10.464	#	CG
...
preg_t_minus1 =	-3.227 # utility from pregnancy - pregnancy in t-1
preg_kids =  -1.98     # utility from pregnancy - number of kide
...
stigma	=	-44.742	#	disutility from welfare	disutility from welfare
stigma96	=	-61.543	#	disutility from welfare after 1996	disutility from welfare after 1996
p_alimony	=	-0.483	#	prob of having alimony for single mothers	prob of having alimony for single mothers
alimony	=	8.689	#	mean of alimony	exp of draw fron mormal distribution
# utility parameters
...
alpha12_h	=	-0.004	#	utility parameters -husband	leisure by  education
alpha13_h	=	0.058	#	utility parameters -husband	leisure by health
...
dc_w	=	-1.579	#	fixed cost of divorce wife	alpha4
dc_h	=	-1.691	#	fixed cost of divorce husband	alpha4
dc_w_kids	=	-0.372	#	fixed cost of divorce child wife	alpha4
dc_h_kids	=	-0.260	#	fixed cost of divorce child husband	alpha4
tau0_w	=	0.493	#	Home Time Equation - wife	constant
tau1_w	=	0.942	#	home time equation - wife	ar coefficient
tau2_w	=	1.493	#	home time equation - wife	pregnancy in previous period
tau0_h	=	0.138	#	home time equation - husband	constant
...
#  ability parameters
ab_high1 	=	-0.918	#	ability parameters - high	%high ability constant
ab_high2 	=	1.211	#	ability parameters - high	%high ability parents education
ab_high3 	=	0.413	#	ability parameters - high	%high ability perents married
ab_medium1	=	-0.460	#	ability parameters - medium	%medium ability constant
ab_medium2	=	0.399	#	ability parameters - medium	%medium ability parents education
ab_medium3	=	0.272	#	ability parameters - medium	%medium ability parents married
# error terms variance
sigma_ability_w	=	-0.549	#	random shock variance matrix	variance wife ability
sigma_ability_h	=	-0.592	#	random shock variance matrix	variance husband ability
sigma_hp_w	=	-1.426	#	random shock variance matrix	variance home time wife
sigma_hp_h	=	-1.312	#	random shock variance matrix	variance home time husband
sigma_w_wage	=	-0.620	#	random shock variance matrix	wife's wage error variance
sigma_h_wage	=	-0.624	#	random shock variance matrix	husband's wage error variance
sigma_q	=	-0.822	#	random shock variance matrix	match quality variance
sigma_p	=	-0.225	#	random shock variance matrix	pregnancy
# utility from schooling parameters
s1_w	=	0.432	#	utility from schooling - wife	s1_wconstant
s2_w	=	1.469	#	utility from schooling - wife	s2_w mother is CG
s3_w	=	0.674	#	utility from schooling - wife	s3_w return for ability
s4_w	=	-1.429	#	utility from schooling - wife+husband	s4_w post high school tuition
s1_h	=	0.375	#	utility from schooling - husband	s1_hconstant
s2_h	=	0.582	#	utility from schooling - husband	s2_h mother is  CG
s3_h	=	0.719	#	utility from schooling - husband	s3_h return for ability
# terminal value parameters
t1_w	=	10.918	#	terminal value- wife	ind. Education - HSG
t2_w	=	30.462	#	terminal value- wife	ind. Education - SC
t3_w	=	35.885	#	terminal value- wife	ind. Education - CG
t4_w	=	57.247	#	terminal value- wife	ind. Education - PC
t5_w	=	21.278	#	terminal value- wife	experience
t6_w	=	8.210	#	terminal value- wife	partner education - HSG
t7_w	=	13.216	#	terminal value- wife	partner education - SC
t8_w	=	58.130	#	terminal value- wife	partner education - CG
t9_w	=	61.873	#	terminal value- wife	partner education - PC
t10_w	=	16.833	#	terminal value- wife	partner experience
t11_w	=	112.743	#	terminal value- wife	marriage utility
t1_h	=	26.942	#	terminal value- husband	ind. Education - HSG
t2_h	=	35.655	#	terminal value- husband	ind. Education - SC
t3_h	=	39.843	#	terminal value- husband	ind. Education - CG
t4_h	=	58.215	#	terminal value- husband	ind. Education - PC
t5_h	=	5.222	#	terminal value- husband	experience
t6_h	=	17.880	#	terminal value- husband	partner education - HSG
t7_h	=	20.516	#	terminal value- husband	partner education - SC
t8_h	=	23.348	#	terminal value- husband	partner education - CG
t9_h	=	27.876	#	terminal value- husband	partner education - PC
t10_h	=	7.660	#	terminal value- husband	partner experience
